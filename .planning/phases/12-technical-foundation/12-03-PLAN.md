...
must_haves:
  ...
  artifacts:
    - path: "website/src/app/layout.tsx"
      provides: "Heebo font configuration with preload"
      contains: "Heebo"
...
<task type="auto">
  <name>Task 3: Create Motion LazyMotion provider and Lenis smooth scroll</name>
  <files>
    website/src/providers/MotionProvider.tsx
    website/src/components/SmoothScroll.tsx
    website/src/app/layout.tsx
  ...
  <action>
    ...
    Update website/src/app/layout.tsx to include providers:
    ...
    1. DirectionProvider - RTL context for Radix components
    2. MotionProvider - LazyMotion for tree-shaking
    3. SmoothScroll - Lenis smooth scroll with GSAP sync
  ...
  <done>
    Motion LazyMotion provider and Lenis smooth scroll configured with GSAP integration.
  </done>
</task>
