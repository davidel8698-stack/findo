...
must_haves:
  truths:
    - "Accordion expands and collapses smoothly when clicked"
    - "Slider responds to drag gestures with immediate visual feedback"
    - "Slider thumb scales up on hover for playful interaction"
  artifacts:
