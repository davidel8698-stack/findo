...
export interface ScheduledJobData {
  jobType: 'review-check' | 'review-reminder' | 'invoice-poll' | 'photo-request' | 'photo-reminder' | 'monthly-post' | 'post-reminder' | 'daily-digest' | 'token-refresh' | 'holiday-check' | 'metrics-collection' | 'auto-tuning' | 'test';
